...
- **The view reaches up to `mirror-view-depth` from your eye** (64 by default, up to 128) and ends in fog, like the world at the render distance: white by the far world's day, black by its night. How far your own view reaches is what one redraw can afford, up to that: shorter right against the mirror, where the view is widest, and shorter while you walk, growing to the full depth over a second or so when you stand still.
