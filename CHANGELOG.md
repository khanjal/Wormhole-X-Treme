...
- **A lever on the empty iris spot of a gate with no code does nothing.** It shut the iris,
  and with no code and no lever of its own the gate had nothing to open it with.
