...
class DefaultSettings
{
    ...
    static final Group[] groups = {
        ...
        group("Stargates", "",
            ...
            new Setting(ConfigKeys.GATE_DIAL_SPIN, "TOP", "How a dialling gate's inner ring light moves before each chevron locks: TOP, CHEVRON, LAP, FILL, PEGASUS or NONE. Each is described in the gate guide. None changes how fast a gate dials.", SECTION),
        ...
        group("Stargate sounds", SOUNDS,
            ...
            new Setting(ConfigKeys.GATE_IRIS_STEP_TICKS, 2, "Ticks between one ring of an iris sweep and the next, 1 to 20.", SECTION),
            new Setting(ConfigKeys.GATE_IRIS_SWEEP_TICKS, 20, "The longest a whole iris sweep may take, in ticks, 1 to 100. A gate with more rings than fit crosses several at once, so a Grand closes about as fast as a Standard.", SECTION),
