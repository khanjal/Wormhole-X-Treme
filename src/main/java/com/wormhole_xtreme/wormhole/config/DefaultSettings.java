...
class DefaultSettings
{
    ...
    final static Setting[] config = {
        ...
        new Setting(ConfigKeys.RING_DEFAULT_LIGHT, "REDSTONE_LAMP", "What the ring pad lights up as while it is working.", "WormholeXTreme"),
        ...
        new Setting(ConfigKeys.RING_DEFAULT_FLASH, "REDSTONE_LAMP", "What a ring turns to as the transport light passes through it. Set it apart from the pad light to make the transport its own moment.", "WormholeXTreme"),
