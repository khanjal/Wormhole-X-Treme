...
class DefaultSettings
{
    ...
    static final Group[] groups = {
        ...
        group("Stargates", "",
            ...
            new Setting(ConfigKeys.GATE_DIAL_SPIN, "TOP", "How a dialling gate's inner ring light moves before each chevron locks: TOP, CHEVRON, LAP, FILL, PEGASUS, CHASE, UNIVERSE, OVERSHOOT or NONE. Each is described in the gate guide. TOP dials slower, resting half a second on the top chevron after each lock, and UNIVERSE a little, turning about a full turn for each at its own pace.", SECTION),
