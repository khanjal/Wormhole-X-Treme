...
class DefaultSettings
{
    ...
    static final Group[] groups = {
        ...
        group("Stargates", "",
            ...
            new Setting(ConfigKeys.GATE_DIAL_SPIN, "CHEVRON", "How a dialling gate's inner ring light moves before each chevron locks: CHEVRON (half the ring, landing on the chevron), TOP (half the ring to the top), LAP (a whole turn to the chevron), FILL (filling in behind the light), PEGASUS (a glyph at a time, a whole turn clockwise) or NONE. None changes how fast a gate dials.", SECTION),
