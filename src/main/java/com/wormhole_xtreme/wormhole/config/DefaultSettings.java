...
class DefaultSettings
{
     ...
     */
    record Group(String heading, String intro, Setting... settings)
    {
    }
    ...
    static final Group[] groups = {
        ...
        new Group("Economy", "Shared by gates and beaming; both need this enabled before any cost applies.",
        ...
        new Group("Stargate sounds", SOUNDS,
        ...
        new Group("Transport ring sounds", SOUNDS,
        ...
        new Group("Beaming sounds", SOUNDS,
    ...
    private static Setting[] flatten()
    {
        ...
        {
            all.addAll(List.of(group.settings()));
        }
    ...
    private static Map<ConfigKeys, Group> opens()
    {
        ...
        for (final Group group : groups)
        {
            ...
            {
                first.put(group.settings()[0].getName(), group);
            }
        }
        return first;
    }
