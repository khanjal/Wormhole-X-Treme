...
class DefaultSettings
{
    ...
    static final Group[] groups = {
        ...
        group("Stargates", "",
            ...
            new Setting(ConfigKeys.GATE_PREVIEW_MINUTES, 10, "Minutes a /wormhole gate build preview stays up after its owner last used a gate build or gate preview command. At least 1.", SECTION),
