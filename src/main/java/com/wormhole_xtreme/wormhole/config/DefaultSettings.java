...
class DefaultSettings
{
    ...
    static final Group[] groups = {
        ...
        group("Stargates", "",
            ...
            new Setting(ConfigKeys.GATE_DIAL_SPIN, "TOP", "How a dialling gate's inner ring light moves before each chevron locks: TOP, CHEVRON, LAP, FILL, PEGASUS, CHASE, UNIVERSE, OVERSHOOT or NONE. Each is described in the gate guide. Only TOP changes how fast a gate dials, resting half a second on the top chevron after each lock.", SECTION),
