...
class DefaultSettings
{
    ...
    static final Group[] groups = {
        ...
        group("Stargates", "",
            ...
            new Setting(ConfigKeys.GATE_DIAL_SPIN, "CHEVRON", "How a dialling gate's inner ring light moves before each chevron locks: CHEVRON (half the ring, landing on the chevron), TOP (half the ring to the top), LAP (round and round, a whole turn clockwise to the chevron), FILL (filling in behind the light), PEGASUS (from the chevron last locked to the next, anticlockwise first then alternating, a glyph at a time, as an Atlantis gate dials) or NONE. None changes how fast a gate dials.", SECTION),
