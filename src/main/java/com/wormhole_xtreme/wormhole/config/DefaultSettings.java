...
class DefaultSettings
{
    ...
    final static Setting[] config = {
        ...
        new Setting(ConfigKeys.SIGN_COLOR_SELECTED, "GREEN", "Colour of the destination currently selected on a dial sign. Kept distinct from the neighbours either side of it, since telling those apart at a glance is the whole point of the dial sign.", "WormholeXTreme"),
        new Setting(ConfigKeys.SIGN_COLOR_NEIGHBOUR, "DARK_GRAY", "Colour of the destinations either side of the selected one on a dial sign.", "WormholeXTreme"),
